...
public class StringUtils {
    ...
    public static String removeAll(String origin,String... removes){
        String target = origin;
        if (Objects.isNull(origin)) return null;
        for (String remove: removes) {
            target = target.replaceAll(remove,"");
        }
        return target;
    }

    public static String trimToNul(String string){
