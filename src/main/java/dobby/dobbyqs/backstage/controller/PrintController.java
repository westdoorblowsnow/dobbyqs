...
public class PrintController {
    ...
    @Resource
    BackPaperService paperService;

    @GetMapping("/backstage/answer")
    public String answer(Integer paperId, Model model) {
        Paper paper = null;
        ...
        if (Objects.nonNull(paper)) {
            final Map<String, List<BackQuestion>> map = paperService.getQuestionsByPaperId(paper.getId());
